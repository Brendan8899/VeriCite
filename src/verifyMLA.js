...
async function isValidMLA(citation) {
  ...
  if ((looksLikeArticle.test(normalised) || looksLikeWebsite.test(normalised) || looksLikeChapter.test(normalised))
  ...
  const looksLikeBook = !looksLikeArticle.test(normalised)
