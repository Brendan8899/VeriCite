...
describe('hasYear', () => {
  ...
  test('finds a standard year', () => {
    expect(hasYear('Smith, J. (2021). Title. Journal.')).toMatchObject({ found: true, value: 2021 });
  });

  test('finds year with month', () => {
    expect(hasYear('Smith, J. (2021, March 5). Title.')).toMatchObject({ found: true, value: 2021 });
  });
